...
def addLandmarks(
    ...
    latitude/longitude for various spots around San Jose from Google Maps; these
...
def computeDistance(geo1: GeoLocation, geo2: GeoLocation) -> float:
    ...
    *Haversine formula* to compute distance subject to the curved surface.
    ...
    Note :: For small distances (e.g., San Jose --> the greater Bay Area),
...
def createSanJoseMap() -> CityMap:
    cityMap = readMap("data/sanjose.pbf")
    addLandmarks(cityMap, "data/sanjose-landmarks.json")
    return cityMap
