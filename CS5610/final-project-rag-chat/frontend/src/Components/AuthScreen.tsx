  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md bg-surface border border-neutral-800 rounded-2xl p-8 shadow-2xl animate-in zoom-in-95 duration-300">
        ...
        <div className="mt-6 p-4 bg-neutral-900/30 rounded-xl text-xs text-neutral-500 text-center border border-neutral-800/50">
          <div className="mb-2 uppercase tracking-widest text-[10px] text-neutral-600 font-semibold">Demo Credentials</div>
          <div className="flex justify-center gap-4">
            <div className="flex flex-col gap-1">
              <span>Username</span>
              <code className="bg-neutral-800 text-neutral-300 px-2 py-1 rounded border border-neutral-700 select-all cursor-text font-mono">
                demo
              </code>
            </div>
            <div className="flex flex-col gap-1">
